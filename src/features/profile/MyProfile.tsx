...
import {
  Edit, Save, X, Upload, MapPin, Calendar, Mail, Phone, User, Heart, Music, Clock,
  Users, Loader2, Plus, Lock, Shield, Star, Award, TrendingUp
} from 'lucide-react';
                  ...
                  {['Trap', 'Reagge', 'Edgy', 'Tecno', 'Reaggeton', 'House', 'Loofy', 'Funk', 'Pop', 'Indie', 'Rock', 'Metal', 'Trendy', 'Pop con ñ', 'España 2000'].map((categoria) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={!isEditing}
                        className={`p-4 border rounded-xl transition-all duration-200 font-medium ${isSelected
                      ...
                      return (
                        ...
                        >
                          <div className="relative h-48 w-full overflow-hidden">
                            <ImageWithFallback
                              src={event.image || 'https://images.unsplash.com/photo-1514525253440-b393452e8d26?auto=format&fit=crop&w=800&q=80'}
                              alt={event.name}
